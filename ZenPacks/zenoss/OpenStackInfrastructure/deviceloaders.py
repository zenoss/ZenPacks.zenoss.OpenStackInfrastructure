...
class OpenStackInfrastructureLoader(object):
    ...
    /Devices/OpenStack/Infrastructure loader='openstackinfrastructure', loader_arg_keys=['deviceName', 'username', 'api_key', 'project_id', 'user_domain_name', 'project_domain_name', 'auth_url', 'region_name', 'collector']
        ostack_test username='admin', api_key='admin_password', project_id='admin', user_domain_name = 'default', 'project_domain_name' = 'default', auth_url='http://10.1.2.3:5000/v2.0/', region_name='RegionOne'
