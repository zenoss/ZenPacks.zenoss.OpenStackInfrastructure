...
# with legacy directives provided by PythonCollector zenpack, add some tweaks here 
# to make directives work with old and new ADM

try:
    import Products.DataCollector.ApplyDataMap
except ImportError:
