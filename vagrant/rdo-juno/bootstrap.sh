...
packstack --allinone --os-ceilometer-install=y --os-controller-host=192.168.2.12 --os-compute-hosts=192.168.2.12 --os-network-hosts=192.168.2.12 --vcenter-host=192.168.2.12 --amqp-host=192.168.2.12 --mariadb-host=192.168.2.12 --mongodb-host=192.168.2.12 --novanetwork-pubif=eth1 --novanetwork-fixed-range=192.168.32.0/22 --novanetwork-floating-range=10.3.4.0/22 --os-neutron-ml2-type-drivers=local --os-neutron-ml2-tenant-network-types=local --os-neutron-ml2-mechanism-drivers=openvswitch --use-epel=y
...
# bounce ceilometer.
for e in openstack-ceilometer-alarm-evaluator openstack-ceilometer-alarm-notifier openstack-ceilometer-api openstack-ceilometer-central openstack-ceilometer-collector openstack-ceilometer-compute openstack-ceilometer-notification; do /bin/systemctl restart $e; done
